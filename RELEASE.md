...
**Make sure the required dependencies are installed specified for the platform.**
...
- The `Version` constant in the `std/jule` package must be set to the new planned version with `@master` tag, like `jule0.2.1 @master`.
