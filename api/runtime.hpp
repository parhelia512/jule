...
__jule_String __jule_ptrToStr(void *p);
__jule_String __jule_boolToStr(__jule_Bool b);
__jule_String __jule_i64ToStr(__jule_I64 x);
__jule_String __jule_u64ToStr(__jule_U64 x);
__jule_String __jule_f64ToStr(__jule_F64 x);
...
__jule_Int __jule_compareStr(__jule_String *a, __jule_String *b);
...
void __jule_panicStr(__jule_String m);
__jule_String __jule_bytesToStr(__jule_Slice<__jule_U8> bytes);
__jule_String __jule_runesToStr(__jule_Slice<__jule_I32> runes);
__jule_Slice<__jule_I32> __jule_strToRunes(__jule_String s);
__jule_Slice<__jule_U8> __jule_strToBytes(__jule_String s);
__jule_String __jule_strFromByte(__jule_U8 b);
__jule_String __jule_strFromRune(__jule_I32 r);
...
__jule_String __jule_strBytePtr(__jule_U8 *b, __jule_Int n);
__jule_Slice<__jule_U8> __jule_sliceBytePtr(__jule_U8 *b, __jule_Int len,
                                            __jule_Int cap);
__jule_Slice<__jule_U8> __jule_strAsSlice(__jule_String s);
__jule_String __jule_sliceAsStr(__jule_Slice<__jule_U8> b);
